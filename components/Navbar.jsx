export default ()=>{
    return( 
        <>
          ...
          {/* <div className="search-bar py-3 text-center flex justify-center w-11/12 align"> */}
             <form className="flex py-3 w-full text-center m-auto">
                <input type={"text"} className=" w-full px-3 py-2 m-auto relative left-3" placeholder="Search for products & brands"></input>
